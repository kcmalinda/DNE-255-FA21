...
switch ($roles) {
                ...
                $the_cmd = Read-Host -Prompt "Enter 'SCP' if you'd like to save the file to a remote system or leave blank to save it locally"

                if ($the_cmd -eq 'SCP') {
    
                 Set-SCPItem -ComputerName 'mail01.kcmalinda.local' (Get-Credential kcmalinda) -Destination '/home/kcmalinda/hw-oct29' -Path '.\iptables.bash'
    ...
    Set-SCPItem -ComputerName 'mail01.kcmalinda.local' (Get-Credential kcmalinda) -Destination '/home/kcmalinda/hw-oct29' -Path '.\cisco.txt'
    ...
    Set-SCPItem -ComputerName 'mail01.kcmalinda.local' (Get-Credential kcmalinda) -Destination '/home/kcmalinda/hw-oct29' -Path '.\windows.bat'
